        ...
        <div>
            ...
            <div className="d-flex  align-items-center flex-column col-12">
                ...
                <form className='d-flex col-md-8 m-1 '>
                    ...
                    <input onChange={textmeme} className='form-control m-1 ' type='text' placeholder='Escibí tu frase' />
                ...
                <form className='d-flex col-md-8 m-1 '>
                    ...
                    <input onChange={textmeme2} className='form-control m-1 ' type='text' placeholder='Escibí tu frase' />
            ...
            <figure className='text-center' id='exportar'>
                ...
                <img src={`/memesImg/${imgmeme}.jpg`} alt='memes' />
            ...
            <button className='down-btn' onClick={descarga}>Descargar</button>
